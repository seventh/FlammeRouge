...
class Pièce:
    ...
    PIÈCES = {
        # quart-droite
        -2: {
            0: [[16, -16], [15, -12], [14, -8], [11, -5], [8, -2], [4, -1],
                [0, 0], [0, 64], [9, 63], [18, 62], [26, 60], [35, 56],
                [43, 52], [50, 47], [57, 41], [63, 34], [68, 27], [72, 19],
                [76, 10], [78, 2], [79, -7], [80, -16]],
            1: [[23, 0], [68, 45], [61, 51], [54, 56], [46, 60], [37, 64],
                [29, 66], [20, 67], [11, 68], [2, 67], [-7, 66], [-15, 64],
                [-24, 60], [-32, 56], [-39, 51], [-45, 45], [0, 0], [3, 3],
                [7, 4], [11, 5], [15, 4], [19, 3]],
        },
        # huitième-droite
        -1: {
        ...
        # quart-gauche
        2: {
            0: [[80, 80], [16, 80], [15, 76], [14, 72], [11, 69], [8, 66],
                [4, 65], [0, 64], [0, 0], [9, 1], [18, 2], [26, 4], [35, 8],
                [43, 12], [50, 17], [57, 23], [63, 30], [68, 37], [72, 45],
                [76, 54], [78, 62], [79, 71]],
            1: [[0, 113], [-45, 68], [-42, 65], [-41, 61], [-40, 57],
                [-41, 53], [-42, 49], [-45, 45], [0, 0], [6, 7], [11, 14],
                [15, 22], [19, 31], [21, 39], [22, 48], [23, 57], [22, 66],
                [21, 75], [19, 83], [15, 92], [11, 100], [6, 107]],
        },
    }
